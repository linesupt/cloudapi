...
public class HttpClientUtil1 {
     ...
     * @create 2018年07月09日
     */
    public static boolean get(String url, String filepath) {
        ...
        try {
            ...
            File desc = new File(filepath + File.separator + urlArray[maxValue]);
            ...
            is.close();
            os.close();
            System.out.println(filepath + File.separator + urlArray[maxValue]);
            return true;
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
    ...
    public static void main(String[] args) {
        // URL列表数组
        String[] urisToGet = {"https://mp.csdn.net/postlist", "https://mp.csdn.net/postlist",
                "https://mp.csdn.net/postlist", "https://mp.csdn.net/postlist",

                "https://mp.csdn.net/postlist", "https://mp.csdn.net/postlist", "https://mp.csdn.net/postlist",
